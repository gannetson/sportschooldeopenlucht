...
ROOT_URLCONF = 'sportschool.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sportschool.wsgi.application'
...
# E-mail settings
DEFAULT_FROM_EMAIL = '<website@sportschooldeopenlucht.nl> Sportschool de Openlucht'
